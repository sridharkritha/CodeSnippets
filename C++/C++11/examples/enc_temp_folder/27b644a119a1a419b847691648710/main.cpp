...
// WITHOUT virtual destructor but 'shared_ptr'(NOT unique pointer supports virtual destruction) is used for creating the object
...
class AnimalFactory {
	...
	static shared_ptr<BlueLion> createBlueLion() {
		return shared_ptr<BlueLion> (new BlueLion());
	}
};
...
//////////////////////////////////////////////////////////////////////////////////////////////////
// Ref: Advanced C++: Disallow Functions
...
int main() {
	...
	Dog *h = new Dog(string("hello HEAP"));
	h->destroyME();
}
